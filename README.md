...
The "Getting Started" docs can be found at [https://learn.microsoft.com/azure/databricks/dev-tools/bundles/mlops-stacks](https://learn.microsoft.com/azure/databricks/dev-tools/bundles/mlops-stacks).
